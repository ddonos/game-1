...
Stage metadata now lives in TypeScript config and defines duration, boss flag, spawn interval, enemy speed multiplier, weighted enemy mix, reward multipliers, and enemy shooting pressure. Later stages may increase shooting pressure through stage fire-rate multipliers. Power-up frequency may also be tuned by stage later. Later phases should expand this into richer spawn plans, hazard plans, boss behavior, reward tuning, and presentation notes.
