...
All assets must be tracked in `docs/ASSET_REGISTER.md`, including licence and commercial-use notes. Phase 0 through Phase 9 use only runtime placeholders and add no final assets.
